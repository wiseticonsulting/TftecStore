...
namespace TFTEC.Web.Ecommerce.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,CategoriaNome,Descricao,CreatedOn,ModifiedOn")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,CategoriaNome,Descricao,CreatedOn,ModifiedOn")] Categoria categoria)
        {
